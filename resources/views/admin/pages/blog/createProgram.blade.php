    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action={{ url('/admin/program-name') }} method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='slug_name' id="basic-default-company"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <img id="output" class="imageData" src="#" alt="pic" height="90px"
                                    width="90px" />
                            </div>
                        </div>
